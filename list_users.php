            ...
            <?php foreach ($users as $user): ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="change_status_user.php?id=<?php echo $user['id_user']; ?>&status=<?php echo $user['stat'] == 1 ? 0 : 1; ?>">
                            <button class="status-button <?php echo $user['stat'] == 1 ? '' : 'inactive'; ?>">
                                <?php echo $user['stat'] == 1 ? 'Desactivar' : 'Activar'; ?>
                            </button>
                        </a>
                    </td>
                </tr>
